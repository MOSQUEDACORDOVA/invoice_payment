  ...
  module.exports = {
    ...
    APYKeyGet(hostLink){
      ...
      var options = {
        ...
        method: 'POST',
        hostname: hostLink,
        path:  '/oauth2/v1/token?grant_type=client_credentials&scope=ACH-Payments%20ACH-Payments-Status',
        key:keyA , 
        cert: crt,
        headers: {
      ...
      let crt =fs.readFileSync(file_N,'utf8', (error, data) => {
       ...
       return data;
        ...
        var options = {
          ...
          console.log('313 WFCTRL',options)
        var req2 = http.request(options, function (res2) {
          var chunks = [];
          res2.on('data', function (chunk) {    
            chunks.push(chunk);
        ...
        console.log('361 WFCTRL',payload)
        req2.write(payload);
        req2.end();
      })
      },
